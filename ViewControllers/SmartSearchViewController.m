...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.littleCollectionView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:0 inSection:0] atScrollPosition:UICollectionViewScrollPositionBottom animated:NO];
    return cell;
}
...
{
    //删除对应tag的对象
    [_selectArray removeObjectAtIndex:button.tag-100];
    //重新更新视图
    [self refreshTopView];
}
@end
