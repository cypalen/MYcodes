...
#import "CYFreeViewController.h"

@interface CYFreeViewController ()

@end

@implementation CYFreeViewController

- (id)init
{
    self = [super init];
    if (self) {
        [self setTabBarItemTitle:@"免费" imageName:@"tabbar_appfree" selectedImageName:@"tabbar_appfree_press"];
    }
    return self;
}
